...
export default function busf({navigation}) {
    const ref=useRef()
    return(<View style={styles.container}>
        ...
        <View style={{height:'90%',backgroundColor:'white',marginTop:10}}>
            <WebView ref={ref} source={{uri:'https://c0hr.com/%d8%a7%d8%b3%d8%aa%d9%82%d8%b7%d8%a7%d8%a8-%d8%a7%d9%84%d9%85%d9%88%d8%a7%d9%87%d8%a8-%d8%a7%d9%84%d9%88%d8%b8%d9%8a%d9%81%d9%8a%d8%a9'}} style={{width:'100%',height:'100%'}} />
        </View>
