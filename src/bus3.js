...
export default function bust({navigation}) {
    const ref=useRef()
    return(<View style={styles.container}>
        ...
        <View style={{height:'90%',backgroundColor:'white',marginTop:10}}>
            <WebView ref={ref} source={{uri:'https://c0hr.com/%d8%ae%d8%af%d9%85%d8%a9-%d8%a7%d9%84%d8%a7%d8%b3%d8%aa%d8%b4%d8%a7%d8%b1%d8%a7%d8%aa-%d8%a7%d9%84%d8%a5%d8%af%d8%a7%d8%b1%d9%8a%d8%a9'}} style={{width:'100%',height:'100%'}} />
        </View>
